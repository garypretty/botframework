...
The latest version of QnAMakerDialog now works with v3 of the QnA Maker API, allowing you to get multiple answers back from the service and use metadata to filter or boost answers within your knowledgebase. For more information about the v3 API see https://westus.dev.cognitive.microsoft.com/docs/services/597029932bcd590e74b648fb/operations/597037798a8bb5031800bf5b.
